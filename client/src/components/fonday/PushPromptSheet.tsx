        ...
        {showIOSGuide ? (
          <>
            <div className="text-center mb-5">
              ...
              <h3 className="font-semibold text-[#5C4F4A] text-lg mt-2">{t("pushPrompt.iosTitle")}</h3>
            ...
            <div className="space-y-3.5 mb-5">
              {([1, 2, 3] as const).map(n => (
                <div key={n} className="flex items-center gap-3 rounded-2xl px-4 py-3 border" style={{ background: BG_MUTED, borderColor: BORDER_COLOR }}>
                  ...
                  <span className="text-[13px] text-[#6B5D55]">{t(`pushPrompt.iosStep${n}`)}</span>
                </div>
              ))}
            </div>
          </>
          ...
          <>
            <div className="text-center mb-6">
              ...
              <h3 className="font-semibold text-[#5C4F4A] text-lg mt-2">{t("pushPrompt.title")}</h3>
