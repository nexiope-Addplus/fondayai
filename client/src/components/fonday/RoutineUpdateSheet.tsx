        ...
        {open && (
          <motion.div className="fixed inset-0 z-[120] flex items-end justify-center"
            ...
            >
              ...
              <p className="text-base font-semibold text-center" style={{ color: DEEP_GREEN }}>{t("cosmetics.routineUpdateTitle")}</p>
              ...
              <div className="flex gap-2 mt-5">
                <button
                  onClick={onClose}
                  className="flex-1 py-3.5 rounded-2xl text-[13px] font-semibold text-stone-600 bg-stone-50"
                >
