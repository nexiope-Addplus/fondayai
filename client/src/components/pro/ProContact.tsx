      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid md:grid-cols-[1fr_1fr] gap-12 items-start">
          <div>
            ...
            <div className="mt-8 space-y-4">
              <div className="flex items-center gap-3 text-slate-600">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#E9F4F2]">
                  <Mail className="h-4 w-4 text-[#1F5F57]" />
                </div>
                <div>
                  <p className="text-sm text-slate-400">{"이메일"}</p>
                  <a href="mailto:nexiope@gmail.com" className="text-sm font-semibold text-slate-900 hover:text-[#1F5F57]">
                    nexiope@gmail.com
                  </a>
                </div>
              </div>
          ...
          {sent ? (
            ...
            <form onSubmit={handleSubmit} className="rounded-2xl border border-slate-200 bg-[#F8F9FA] p-6 shadow-sm">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="홍길동"
                    required
                    className="h-11 w-full rounded-lg border border-slate-200 bg-white px-3 text-sm outline-none focus:border-[#1F5F57] focus:ring-2 focus:ring-[#1F5F57]/10"
                  />
                </div>
                <div>
              ...
              <div className="mt-4">
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm outline-none resize-none focus:border-[#1F5F57] focus:ring-2 focus:ring-[#1F5F57]/10"
                />
              </div>
              <button
                type="submit"
                disabled={sending || !name.trim() || !phone.trim()}
                className="mt-4 flex h-11 w-full items-center justify-center gap-2 rounded-lg bg-[#1F5F57] text-sm font-semibold text-white hover:bg-[#174a44] transition-colors disabled:opacity-50"
              >
