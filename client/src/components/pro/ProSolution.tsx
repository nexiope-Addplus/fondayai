...
export default function ProSolution() {
  return (
    <section id="solution" className="py-20 bg-[#F8F9FA]">
          ...
          {STEPS.map((step, i) => (
            <div key={step.num} className="flex items-center">
              ...
              <div className="flex flex-col items-center text-center w-44">
                <div className="w-14 h-14 rounded-2xl bg-[#1F5F57]/10 flex items-center justify-center mb-3">
                  <step.icon size={24} className="text-[#1F5F57]" />
                </div>
        ...
        <div className="mt-14 grid grid-cols-2 md:grid-cols-4 gap-5">
          {[
            ...
            <div key={item.label} className="text-center">
              <div className="rounded-[14px] bg-[#2c2c2e] p-[5px] shadow-lg">
