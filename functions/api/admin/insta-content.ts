...
## 콘텐츠 구조 (캐러셀 5장)
1장: 후킹 — 스크롤 멈추게 하는 한 줄. 의문/반전/숫자로 시작
2장: 핵심 정보 1 — 성분 또는 데이터 포인트
3장: 핵심 정보 2 — 구체적 비교 또는 주의사항
4장: 핵심 정보 3 — 실전 적용법
5장: CTA — "내 피부 타입에 맞는 성분 찾기 → 프로필 링크" (Fonday 앱 유도)
...
## 출력 형식 (반드시 유효한 JSON)
{
  "hook": "첫 줄 후킹 텍스트",
  "slides": [
    { "title": "슬라이드/씬 제목", "body": "본문 내용 (3~5문장)" },
    ...5개
  ],
