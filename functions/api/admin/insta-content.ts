...
2장: 핵심 포인트 1 — 키워드 (8자 이내) + 설명 한 줄 (25자 이내) + 팁 한 줄 (20자 이내)
3장: 핵심 포인트 2 — 같은 구조
4장: 핵심 포인트 3 — 같은 구조
5장: CTA — 행동 유도 한 줄 (20자 이내)

각 슬라이드의 body는 반드시 25자 이내 한 줄로. 길면 안 읽음.
각 슬라이드의 title은 핵심 키워드만 (8자 이내).
각 슬라이드에 tip 필드를 추가 (실전 팁 한 줄, 20자 이내).
...
## 출력 형식 (반드시 유효한 JSON)
{
  ...
  "slides": [
    { "title": "키워드 (8자 이내)", "body": "설명 한 줄 (25자 이내)", "tip": "팁 한 줄 (20자 이내)" },
    { "title": "키워드", "body": "설명 한 줄", "tip": "팁 한 줄" },
    { "title": "키워드", "body": "설명 한 줄", "tip": "팁 한 줄" },
    { "title": "키워드", "body": "설명 한 줄", "tip": "팁 한 줄" },
    { "title": "키워드", "body": "설명 한 줄", "tip": "팁 한 줄" }
  ],
