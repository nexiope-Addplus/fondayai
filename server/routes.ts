...
improvements: 분석 결과 기반 구체적 개선 방안 4가지. title은 5자 이내, desc는 2문장 이내 실용적 조언.

출력 형식 (반드시 이 구조 그대로):
{"scores":[{"label":"종합 컨디션","score":75},{"label":"수분 밸런스","score":60},{"label":"붉은기 수준","score":40},{"label":"모공 상태","score":70},{"label":"주름 및 탄력","score":80},{"label":"잡티/색소침착","score":35},{"label":"트러블 위험","score":30},{"label":"다크서클","score":45},{"label":"피부 광채","score":65},{"label":"피부결 균일도","score":72}],"hotspots":[{"x":45,"y":55,"type":"기미"}],"aiComment":"총평 2~3문장","improvements":[{"title":"수분 보충","desc":"히알루론산 세럼을 아침저녁 사용하세요. 피부 속 수분 장벽을 강화하는 데 도움이 됩니다."},{"title":"자외선 차단","desc":"SPF50+ 선크림을 매일 덧바르세요. 색소침착 예방에 필수입니다."},{"title":"모공 케어","desc":"주 2회 클레이 팩으로 모공 속 피지를 제거하세요. 과도한 세안은 피지 과분비를 유발합니다."},{"title":"진정 루틴","desc":"센텔라·알로에 성분 토너로 피부를 진정시키세요. 자극 없는 순한 제품을 선택하는 것이 중요합니다."}]}`;
