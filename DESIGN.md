...
## 완료 (2026-03-31 Impeccable 9개 검토 기반 전체 수정)

### P0 접근성 (5건)
- [x] 네비바 대비 WCAG AA (#B0A898→#8C8078)
- [x] 11px→12px 라벨 텍스트
- [x] useReducedMotion 6파일 보강
- [x] 로그인 카드 루틴→솔루션 탭 이동
- [x] 3칸 그리드 375px 반응형

### P1 시각+UX (16건)
- [x] 용어 통일 (퀘스트→케어 목표), 에러 메시지, 빈 상태, 로그인 카피
- [x] 여백 드라마, 섹션 구분 통일, mb-8 확대
- [x] 점수 glow, delta 애니메이션, CTA 느낌, 마일스톤 티어, 날씨 뱃지 stagger
- [x] font-bold 편중 해소, FONT_DISPLAY 정리, Nunito 제거

### P2 시스템 (7건)
- [x] text-stone 132곳→따뜻한 브라운, 카드 라운딩/중첩, 패딩 통일
- [x] 블롭 제거, 스캔라인 성능, 이모지→lucide

### P3 코드 정리 (5건)
- [x] #FFFFFF 61곳→BG_BASE, 텍스트 202곳→상수, 액센트 59곳→상수

### 누락 보완 (12건)
- [x] 스캐닝 450ms, "분석 중", 바우만 순차, 체크인 아이콘/카피, 체크박스 모션
- [x] 언어 전환 whileTap, 바우만 피드백, 설문 편향 제거, 소셜 프루프, DiaryHelpers 모션

### 추가 (7건)
- [x] 번역 5건 (미사용/루틴 체크/점수 변화/14일/감정 케어)
- [x] 재스캔 버튼 점수 아래로 이동 + pull-to-refresh 개선
- [x] CTA "내 피부 분석하고 맞춤 케어 받기"
- [x] 날씨카드 이모지→lucide 아이콘
- [x] OG 이미지 "Analyze Your Skin & Get Custom Care"

## 미완료 / 다음 세션 TODO
- [ ] **보조 버튼 스타일 통일** — 화면별 맥락 달라 점진적 적용
- [ ] **OSNT 설명** — 모바일 터치 UX 설계 필요
- [ ] **한/영 혜택 문구 정렬** — heroBenefit2/3 기준 결정
- [ ] **체크박스 emerald→DEEP_GREEN** — Tailwind→inline 변환
- [ ] **일기 탭 게스트 체험** — DB 구조 설계 필요
- [ ] **모달/시트 디자인** — z-index/radius/backdrop 통일
- [ ] **접근성** — aria-label 보강
- [ ] **반응형** — 태블릿/데스크톱 레이아웃
- [ ] **다크 모드** — 미적용
- [ ] **빈 상태 비주얼** — SVG 일러스트
- [ ] **커스텀 아이콘/일러스트** — 프로 앱 수준
